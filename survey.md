...
This report summarizes 12 highly impactful, peer-reviewed papers published in 2025 across Generative AI (GenAI) and Explainable AI (xAI). All selected papers exclude "technical reports," include open-source code/datasets, and are feasible to reproduce in a Kaggle environment (using T4 or P100 GPUs). 

## Part 1: Top 6 Generative AI (GenAI) Papers
...
* **Link:** https://arxiv.org/abs/2502.09992 (NeurIPS 2025)
...
* **Link:** https://arxiv.org/abs/2410.10629 (ICLR 2025 Oral)
...
* **Link:** https://arxiv.org/abs/2410.10819 (NeurIPS 2025)
* **GitHub / Code:** Provided via NeurIPS 2025 OpenReview
...
* **Link:** https://arxiv.org/abs/2408.11811 (ICLR 2025 Oral)
* **GitHub / Code:** https://github.com/baaivision/EmbodiedSAM
...
* **Link:** https://openreview.net/forum?id=LayerDAG (ICLR 2025)
* **GitHub / Code:** https://github.com/Graph-COM/LayerDAG
...
* **Link:** https://arxiv.org/abs/2410.02410 (NeurIPS 2025)
...
## Part 2: Top 6 Explainable AI (xAI) Papers
...
* **GitHub / Code:** https://github.com/ChenQian0618/SHEP
...
* **Link:** https://arxiv.org/abs/2502.06424
* **GitHub / Code:** https://github.com/ChenQian0618/Homepage
...
* **Link:** https://openreview.net/forum?id=Monet (ICLR 2025)
...
* **Link:** https://openreview.net/forum?id=Understanding_MCQA (ICLR 2025)
* **GitHub / Code:** https://github.com/allenai/understanding_mcqa
...
* **Link:** https://openreview.net/forum?id=PhysicsLM (ICLR 2025)
* **GitHub / Code:** https://youtu.be/yBL7J0kgldU&t=2220 (Data/Code linked via project site)
...
* **Link:** https://aclanthology.org/2025.findings-emnlp.745.pdf (EMNLP 2025 Findings)
